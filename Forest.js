...
function setUp() {
    ...
    this.roof = AM.getAsset("./img/forest/castle.png"); // castle roof
    this.forestOne = AM.getAsset("./img/forest/forest1.png"); // forest1
    this.forestTwo = AM.getAsset("./img/forest/forest2.png"); // forest1
    this.forestThree = AM.getAsset("./img/forest/forest3.jpg"); // forest1
        ...
        for (let j = 0; j < 50; j++) {
            ...
            if (
                ...
                grid[i][j] = new Cell(
                    i,
                    j,
                    new Component(this.forestOne, i * w, j * w, 100, 85, "t")
                );
            } else if (
                ...
                grid[i][j] = new Cell(
                    i,
                    j,
                    new Component(this.roof, i * w, j * w, 400, 300, "r")
                );
            } else {
