function Component(game,decoration,width,height, locationX, locationY) {
...
Enviornment.prototype.draw = function () {
    ...
    this.wall = new Component(this.game,AM.getAsset("./img/background/crate.png"), 50, 50,700,700);
    this.ctx. drawImage(this.wall.decoration, 700,700);
